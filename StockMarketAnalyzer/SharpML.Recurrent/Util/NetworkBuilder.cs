...
namespace SharpML.Recurrent.Util
{
    public static class NetworkBuilder
    {
        ...
        public static INetwork MakeFeedForward(int inputDimension, int hiddenDimension, int hiddenLayers, int outputDimension, object p1, object p2, double initParamsStdDev, Random rng)
        {
        ...
        public static NeuralNetwork MakeFeedForward2(int inputDimension, int hiddenDimension, int hiddenLayers, int outputDimension, INonlinearity hiddenUnit, INonlinearity decoderUnit, double initParamsStdDev, Random rng)
        {
            List<ILayer> layers = new List<ILayer>();
            for (int h = 0; h < hiddenLayers; h++)
            {
